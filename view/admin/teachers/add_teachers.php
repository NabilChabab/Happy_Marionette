...
if(isset($_POST['submit'])){
    ...
    $folder = "./image/" . $image;
    $requet = "INSERT INTO `teachers`(`nom`, `prenom`, `departement`, `classe`, `image` , `cin`) VALUES ('$f_name','$l_name','$department','$class','$image','$cin')";
      ...
      <div class="container d-flex justify-content-center" style="margin-top:5%;">
         <form action="" method="post" enctype="multipart/form-data" style="width:50vw; min-width:300px;">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="cin" placeholder="QA184855" required>
            </div>
